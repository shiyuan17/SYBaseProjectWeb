      ...
      <div v-loading="detailLoading" class="flex flex-col gap-4">
        ...
        >
          <ClinicalSubmissionTimeline
            :application-no="detailTracking?.applicationNo"
            :application-removal-at="detailTracking?.specimenRemovalTime"
            :events="detailRecentEvents"
            :patient-id="detailTracking?.patientId"
            :patient-name="detailTracking?.patientName"
