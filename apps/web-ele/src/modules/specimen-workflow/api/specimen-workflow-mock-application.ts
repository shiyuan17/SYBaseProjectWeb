...
import { createAutoGeneratedWorkbenchRecordMock } from './application-registration-workbench-mock';
import {
  getApplicationById,
  getMockState,
...
export async function createApplicationMock(
  ...
  createAutoGeneratedWorkbenchRecordMock({ id: applicationId }, data);
