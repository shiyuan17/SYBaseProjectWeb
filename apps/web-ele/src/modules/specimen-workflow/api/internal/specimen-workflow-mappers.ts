...
function mapSpecimenTrackingSummary(
  ...
  return {
    ...
    registeredByName: specimen.registeredByName ?? null,
    registrationEvaluationItems: specimen.registrationEvaluationItems ?? null,
    ...
    specimenSize: specimen.specimenSize ?? null,
    terminalCode: specimen.terminalCode ?? null,
    verifiedByName: specimen.verifiedByName ?? null,
