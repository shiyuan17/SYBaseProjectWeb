        ...
        >
          <div class="max-w-4xl">
            ...
            <div class="mt-4 flex flex-wrap gap-2 text-xs">
              <span
                class="rounded-full border border-white/15 bg-white/10 px-3 py-1.5"
                >主菜单：制片管理</span
              >
              <span
                class="rounded-full border border-white/15 bg-white/10 px-3 py-1.5"
              ...
              <button
                ...
                @click="
                  currentWorkingBucket
                    ? navigation.goToPath(currentWorkingBucket.path, {
                        mode:
                          currentWorkingBucket.inProgress > 0
                            ? 'queue'
                            : 'exception',
                      })
      ...
      >
        <div class="rounded-2xl border border-border bg-card p-4">
          ...
          <div class="mt-3">
            <ElButton
              type="primary"
              @click="navigation.goToPath('/workflow/pathology-receipt')"
            >
              打开病理接收
            </ElButton>
          </div>
              ...
              <div class="rounded-2xl border border-border bg-card p-4">
                ...
                <div class="mt-3 flex flex-wrap gap-2">
                  <ElButton
                    ...
                    size="small"
                    type="warning"
                    @click="navigation.goToRework({ mode: 'exception' })"
                  >
                    返工
                  </ElButton>
                  <ElButton
          ...
          >
            ...
            <div v-else class="flex flex-col gap-3">
              <div class="rounded-2xl border border-border bg-card p-4">
                ...
                <div class="mt-3">
                  <ElButton type="primary" @click="navigation.goToFrozen()">
                    打开冰冻工作台
                  </ElButton>
                </div>
              </div>
              ...
              >
                ...
                <div class="mt-3 flex flex-wrap gap-2">
                  <ElButton
                    ...
                    @click="
                      item.taskType === 'REWORK'
                        ? navigation.goToRework({
                            caseId: item.caseId,
                            mode: 'exception',
                            pathologyNo: item.pathologyNo ?? undefined,
                          })
                        : navigation.goToTask(item, 'exception')
                    "
                  >
                    进入处理
                  </ElButton>
