...
import type { TrackingTab, WorkflowTimelineStep } from '../utils/tracking';
...
<template>
  <WorkflowSectionCard title="病例摘要">
    <div class="min-w-0 overflow-x-auto">
      <ElDescriptions :column="2" border min-width="480">
  ...
  <div class="technical-tracking-detail-grid min-w-0">
    <WorkflowSectionCard title="追踪详情" class="tracking-detail-card min-w-0">
      <ElTabs
        class="tracking-detail-tabs min-w-0"
        ...
        <ElTabPane label="技术任务与返工" name="work-items">
          <div class="flex flex-col gap-4">
            <div>
              ...
              <div class="tracking-detail-table-scroll min-w-0 overflow-x-auto">
