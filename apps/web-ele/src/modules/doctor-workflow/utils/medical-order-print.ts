import type { MedicalOrderSlidePrintLabel } from '../types/doctor-workflow';
...
export function buildMedicalOrderPrintDocument(
...
export function openMedicalOrderPrintWindow(labels: MedicalOrderSlidePrintLabel[]) {
  ...
  printWindow.document.write(buildMedicalOrderPrintDocument(labels));
