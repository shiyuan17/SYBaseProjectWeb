...
本目录用于存放业务参考资料、数据库资料和分析报告，主要服务于理解现状、还原业务背景和对照外部资料。
...
- 本目录提供背景资料，不替代 [../plans/README.md](../plans/README.md) 的实施决策。
- 当评审或验收文档需要业务背景时，应优先回链到本目录的稳定入口。

## 维护约定

- 业务清单、数据库资料、分析报告优先放在本目录。
- 体量较大的参考资料建议继续使用子目录，并补充该子目录的 `README.md` 作为稳定入口。
