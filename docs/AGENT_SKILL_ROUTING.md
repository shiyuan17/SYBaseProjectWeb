...
| `test-driven-development` | 后端仓 `tdd`，或按 `docs/CODING_RULES.md` 测试基线执行 |
...
| `using-git-worktrees` | `docs/GIT_RULES.md` 第 6 节（规范，非 skill） |
...
> 验证列中“规范要求”指 `AGENTS.md` §7 与 `docs/CODING_RULES.md` 的强制验证回路本身，不依赖任何外部 skill。
